...
// Redirección inteligente si ya hay una sesión activa
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Usamos 'usuario' para el identificador y 'clave' para el password
    ...
    if (login_user($mysqli, $u, $p)) {
        ...
        // Redirección según el rol guardado en la sesión
    ...
    <main class="flex min-h-screen-custom flex-col md:flex-row">
      ...
      <section class="hidden md:flex md:w-1/2 bg-hero-image text-white p-12 flex-col justify-center relative overflow-hidden">
        ...
        <div class="max-w-md mx-auto space-y-8 relative z-10">
          ...
          <div class="space-y-6 pt-8 animate-slide-in-left" style="animation-delay: 0.2s;">
          ...
          <div class="bg-white p-8 md:p-10 rounded-2xl shadow-xl border border-gray-100">
            ...
            <div class="text-center mb-8">
              ...
              <?php if ($err): ?>
                ...
                <div class="mt-4 p-3 bg-red-100 border-l-4 border-red-500 text-red-700 text-sm text-left">
            ...
            <form action="index.php" method="POST" class="space-y-6">
              ...
              <div>
                ...
                <label class="block text-sm font-medium text-gray-700" for="usuario">Usuario o Correo</label>

                <div class="mt-1 relative">

                  <input class="block w-full pl-4 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 transition-all text-sm outline-none"

                         id="usuario" name="usuario" placeholder="admin o ejemplo@correo.com" required type="text" />
              ...
              <div>
                ...
                <p class="mt-4 text-center text-sm text-gray-600">
                  ...
                  ¿No tienes cuenta? <a href="registrar.php" class="text-blue-600 font-medium hover:underline">Regístrate aquí</a>
